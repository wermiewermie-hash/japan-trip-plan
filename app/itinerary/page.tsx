...
const DAYS: Day[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { time: "5:30 PM",      emoji: "🍽️", text: "Dinner",
        links: [{ label: "Dinner", url: "https://www.ochiairo.co.jp/en/cuisine/summer/" }] },
  ...
  },
  {
    ...
    items: [
      ...
      { time: "10–11 AM",    emoji: "💬", text: "Option 1: Private sightseeing taxi, Ochiairo → Mishima Station", note: "¥16,000 total · beautiful drive with possible Mt Fuji views", todo: true,
        links: [{ label: "sightseeing taxi", url: "https://maps.app.goo.gl/MhJodkN16hRYXxe79" }] },
      { time: "10–11 AM",    emoji: "💬", text: "Option 2: Free hotel transfer to Shuzenji, Sunzusen local train to Mishima", note: "¥550 pp · also has Mt Fuji views", todo: true,
        links: [{ label: "Sunzusen local train", url: "https://maps.app.goo.gl/ZCzPCLCrMNvCazGp7" }] },
      ...
      {                      emoji: "💬", text: "Discuss: bigger rooms (Ace Hotel Kyoto) or quieter, out of the way (Prince Hotel Takaragaike)?", todo: true,
        links: [
          { label: "Ace Hotel Kyoto", url: "https://maps.app.goo.gl/26FoSfaK1rkAZnjTA" },
          { label: "Prince Hotel Takaragaike", url: "https://maps.app.goo.gl/zxWkziU8hxtqjNPW6" },
        ] },
      {                      emoji: "🍸", text: "Evening: hotel rooftop bar, Star Bar & nearby bars, or a Ponto-cho izakaya stroll", note: "share cuisine preference and Masumi can book dinner · ~¥10,000 pp", todo: true,
        links: [
          { label: "Star Bar", url: "https://maps.app.goo.gl/icbWXbMW6fzUL1pD6" },
          { label: "izakaya", url: "https://maps.app.goo.gl/Vfu7J2D69gPM15FP6" },
        ] },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      {                    emoji: "🍽️", text: "Evening: Nara is sleepy at night — grab a dinner reservation or go to a bar", note: "Bar Savant, 5 min walk, is fantastic", todo: true,
        links: [{ label: "Bar Savant", url: "https://maps.app.goo.gl/KkTFFRL7q3UMciJQ7" }] },
    ],
